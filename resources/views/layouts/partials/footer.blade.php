<footer id="footer">
    ...
    <div class="container">
        ...
        <div class="footer-section">
            <h1>Nestlé Café</h1>
            <ul>
                <li class="{{ isActive('online-order') }}"><a href="{{ URL::to('order-online') }}">Order Online</a></li>
        ...
        <div class="footer-section">
            ...
            <ul>
                ...
                <li style="margin-bottom:7px;"><a href="https://www.verybestbaking.com/toll-house" target="_blank">Nestl&eacute;<sup>&reg;</sup> Toll House<sup>&reg;</sup> <br>Cafe by Chip<sup>&reg;</sup></a></li>
                ...
                <li><a href="http://www.nestleusa.com/brands/chocolate/nerds" target="_blank">Nerds<sup>&reg;</sup></a></li>
        ...
        <div class="footer-section">
            ...
            <ul>
                <li><a href="http://www.edys.com/" target="_blank">Edy's<sup>&reg;</sup></a></li>
                <li><a href="http://www.dreyers.com/" target="_blank">Dreyer's<sup>&reg;</sup></a></li>
                <li><a href="http://www.nestle.com/brands/ice-cream" target="_blank">Nestl&eacute; Ice Cream<sup>&reg;</sup></a></li>
                <li><a href="http://www.nescafe.com" target="_blank">Nescaf&eacute;</a></li>
                <li><a href="http://www.nestle.gr/brands/prof/buondiespresso" target="_blank">Buondi</a></li>
                <li><a href="https://www.moevenpick-icecream.com" target="_blank">M&ouml;venpick<sup>&reg;</sup></a></li>
        ...
        <div class="footer-section">
            ...
            <ul>
                ...
                <li><a data-load="document" href="Nestle-Tollhouse-Cafe-by-Chip-Nutrition-Facts.pdf" target="_blank">Nutritional Info</a></li>
