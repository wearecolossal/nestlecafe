...
@section('content')
    <div class="col-md-2"><a href="{{ URL::to('admin/cafes/create') }}"
                             class="btn btn-primary pull-left {{ isActive('admin/cafes/archives') ? 'hidden' : null }}"><i
    ...
    <div class="col-md-8 searchbar">
        ...
        <div class="search-response" style="height:25px;width:100%;display:block;"><span class="text-success"></span>
        </div>
    </div>
    <div class="col-md-2 text-right"><a
                href="{{ isActive('admin/cafes') ? URL::to('admin/cafes/archives') : URL::to('admin/cafes') }}"
                class="btn btn-default pull-right">{!! isActive('admin/cafes/archives') ? 'Active Caf&eacute;s' : 'Archived Caf&eacute;s' !!}</a>
    </div>
    <div class="row">
                    ...
                    <tr class="{{ !$cafe->image ? 'danger' : null }} {{ $cafe->draft == 1 ? 'warning text-warning' : null }}">
                        ...
                        <td>
                                    <span class="{{ $cafe->bakery != 1 ? 'hidden' : null }}"><img
                                                src="{{ URL::asset('library/img/loc-bakery.png') }}" width="20"
                                                alt="bakery">
                                    ...
                                    <span class="{{ $cafe->smoothies != 1 ? 'hidden' : null }}"><img
                                                src="{{ URL::asset('library/img/loc-smoothies.png') }}" width="20"
                                                alt="">
