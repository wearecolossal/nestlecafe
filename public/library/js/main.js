    ...
    var filterStores = function (lat, lng, miles) {
        ...
        $.getJSON(filterLocation + lat + "/" + lng + '/' + miles, function (json1) {
            $.each(json1, function (key, data) {
                ...
                $('.map-list').append('' +
                    '<li data-miles="' + data[0].miles + '" class="cafe-list-item"><div class="list-container"><div class="image-container" style="background:url(' + data[0].image + ')"></div><div class="cafe-info"><span class="name">' + data[0].name + ' <a target="_blank" href="' + data[0].facebook + '" class="' + hideFacebook + '"><img src="' + imageLibrary + '/ico-facebook.png" width="15" style="margin-top:-3px;"/></a></span><br>' + '<small>' + data[0].address + '</small>' + (data[0]['hours'].length > 0 ? data[0]['hours'] : null)+
